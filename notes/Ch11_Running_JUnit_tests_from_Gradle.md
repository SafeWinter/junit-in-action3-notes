...
由于书中并未展开讨论 `Maven` 和 `Gradle` 的区别和联系，这里借用 [Code0cean](https://blog.csdn.net/huangjhai) 大佬在博文《[Gradle快速入门学习](https://blog.csdn.net/huangjhai/article/details/148831989)》中归纳的异同点：
...
|     插件支持     |       实现方便       |      实现较难      |         实现方便         |
| 遵循特定目录结构 |         :x:          | :heavy_check_mark: |    :heavy_check_mark:    |
