...
public class SampleServlet
    ...
    /**
     * This method checks to see if the authenticated property has been set up and returns its boolean value.
     *
     * @param request the request instance
     * @return the authentication result with boolean type
     */
